...
/*********************************************************************************************************************/
static DiagnosticSession g_currentSession = SESSION_DEFAULT; // 현재 진단 세션 상태를 저장하는 변수
static uint16 g_sessionTimeoutCounter = 0; // 세션 타임아웃을 세기 위한 10ms 단위 카운터
...
// GPT 타이머 인터럽트에 의해 10ms마다 주기적으로 호출
